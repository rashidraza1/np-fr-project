...
function SurveyPreview({ survey, sections, devices }: { survey: SurveyState; sections: Section[]; devices: DeviceItem[] }) {
          ...
          <CardContent>
            <Tabs defaultValue="builder" className="w-full">
              ...
              <TabsContent value="preview" className="mt-6">
                <SurveyPreview survey={survey} sections={sections} devices={devices} />
              </TabsContent>
            </Tabs>
          </CardContent>
        </Card>
