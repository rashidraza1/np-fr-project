...
export default function EditProductPage() {
    ...
    useEffect(() => {
        ...
        if (id) {
            formik.setValues({
                titleEn: "Super Widget X",
                titleAr: "سوبر ويدجيت X",
                ...
                manualDocument: null,
                brochureDocument: null,
                briefDescEn: "A great widget.",
                briefDescAr: "ويدجيت رائع.",
                descEn: "Detailed description here.",
                descAr: "وصف مفصل هنا.",
                seoTitleEn: "Super Widget X - Best Widget",
                seoTitleAr: "سوبر ويدجيت X - أفضل ويدجيت",
                seoDescEn: "Buy Super Widget X now.",
                seoDescAr: "اشتري سوبر ويدجيت X الآن.",
                seoKeywordsEn: "widget, super, x",
                seoKeywordsAr: "ويدجيت, سوبر, x",
                seoTagsEn: "new, sale",
                seoTagsAr: "جديد, تخفيض",
            });
        }
    }, [id]);
